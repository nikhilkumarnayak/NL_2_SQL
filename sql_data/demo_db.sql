...
DROP TABLE IF EXISTS tblrtEventRequestData;
DROP TABLE IF EXISTS tblrtEventRequestStatus; 
...
INSERT INTO tblrteventrequeststatus (StatusId, Status) VALUES
(1, 'Pending'),
(2, 'Approved'),
(3, 'Removed'),
(4, 'Cancelled'),
